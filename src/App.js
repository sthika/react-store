...
const setLoginBtnState = useCallback(() => {
  ...
  return (
    <div className="app">
      <Router> 
        <Header loginBtnIsActive={loginBtnIsActive} setLoginBtnState = {setLoginBtnState}/>
        <Routes> 
            <Route path="/" element={<Home allProducts={allProducts} />}/> 
            <Route path="/content" element={<Content allProducts={allProducts}/>}/>
            <Route path="/contacts" element={<Contacts allProducts={allProducts}/>}/>
